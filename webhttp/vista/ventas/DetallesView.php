        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <h3 class="card-title">
                            <a href="web/cmdDefaultCrearDetalles" class="btn btn-primary " >Agregar</a>
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="5" class="fs-4 font-weight-bold"> <center>Total:</center></td>
                                    <td><input type="text" class="form-control text-center border-0 fs-4 font-weight-bold" value=" $<?php print_r($d->data[0]->total); ?> "></td>
                                </tr>
                            </tfoot>
                            <tbody>
                                <?php
                                ...
                                foreach ($d->data as $venta) {
                                    print_r("<tr>");
                                    print_r("<td>
                                              <a href='web/cmdDefaultEditarVenta/" . $venta->num_factura . "'><i class='nav-icon fas fa-edit'></i></a>
                                              <a href='web/cmdEliminarProducto/" . $venta->num_factura . "'><i class='nav-icon fas fa-trash'></i></a>
                                            </td>");
