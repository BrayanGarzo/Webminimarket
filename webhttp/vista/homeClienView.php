  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="web/cmdDefaultHomeC">Home</a></li>
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <h6>Le brindamos este medio para que pueda realizar el respectivo pago del producto que desea comprar. !Ojalá y sea de su agrado!</h6>
        <center><img src="public/images/clien.png" alt="" height="600" width="1200"></center>
        </header>
